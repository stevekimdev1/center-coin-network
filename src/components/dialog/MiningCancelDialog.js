                ...
                <View style={styles.dialog}>
                    ...
                    <View style={{ padding: 15 }}>
                        ...
                        {/* <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <View style={{ width: 4, height: 4, backgroundColor: '#222', borderRadius: 4, marginRight: 5 }} />
                            <Text
                                style={{
                                    fontSize: 12,
                                    letterSpacing: -0.05,
                        ...
                        <View style={{ flexDirection: 'row', }}>
                            <View style={{ width: 4, height: 4, backgroundColor: '#222', borderRadius: 4, marginRight: 5, marginTop: 7 }} />
                            <Text
                                style={{
                                    fontSize: 12,
                                    letterSpacing: -0.05,
                    ...
                    {this.props.ok == undefined ? (
                        <View style={{ flexDirection: 'row' }}>
                            <TouchableOpacity
                                style={{ padding: 17, flex: 1, justifyContent: 'center', borderRightWidth: 1, borderRightColor: '#ccc' }}
                                onPress={() => { this.props.close == undefined ? this.dismiss() : (this.close()) }}>
                                <Text style={[layout.buttonText, { color: '#888' }]} >
                                    {string.cancel}
                                </Text>
                            </TouchableOpacity>
                            <TouchableOpacity
